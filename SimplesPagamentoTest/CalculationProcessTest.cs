    ...
    class CalculationProcessTest
    {
        ...
        public void TestHappyPath()
        {
            try
            {
                ...
                FileParameter.FromManifestResource("calculation.bpmn") });
        ...
        {
             Stream entrada = File.Open("calculation.bpmn", FileMode.Open);
             string[] names = Assembly.GetExecutingAssembly().GetManifestResourceNames();
             var teta = Assembly.GetExecutingAssembly();
             var result = Assembly.GetExecutingAssembly().GetManifestResourceStream("E:\\projects\\estudos\\biblioteca-core-camunda\\SimplesPagamentoTest\\bin\\Debug\\netcoreapp2.0\\calculation.bpmn");
        }
    }
}
