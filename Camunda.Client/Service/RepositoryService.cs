...
namespace CamundaClient.Service
{
    ...
    public class RepositoryService
    {
        ...
        public void AutoDeploy(string resourcePath)
        {
            ...
            files.Add(FileParameter.FromManifestResource(resourcePath));

            Console.WriteLine("Adding resource to deployment: " + resourcePath);
